      ...
      {role === "ADMIN" ? (
        <>
          ...
          <div className="top-boxes">
            <Link to="/dashboard/all-users" className="box">View All Users</Link>
            <Link to="/dashboard/all-requests" className="box">All Card Requests</Link>
            <Link to="/dashboard/reports" className="box">Reports</Link>
          </div>
        </>
      ) : (
        <>
