               ...
               <div className="flip-container">
                 <div className="flip-card">
                   ...
                   <div
                     ...
                     style={{
                       background: selectedCard.cardColourFront,
                       color: selectedCard.textColour,
                     }}
                   >
                     <header className="front-header">
                       <img
                         src={
                           NETWORK_LOGOS[selectedCard.networkName]
                         }
                       ...
                       <img
                         ...
                         src={getChip(selectedCard.chipImage)}
                         alt="chip"
                       />
                     </header>
                   ...
                   <div
                     ...
                     style={{
                       background:
                         selectedCard.cardColourBack,
                     }}
                   >
                     <div className="magnetic-strip-top"></div>

                     <div className="signature">
                       <i>{selectedCard.cvv || "XXX"}</i>
                     </div>

                     <h5 className="description">
                       This card is property of the issuing
                       bank.
                     </h5>
                   </div>
